...
keys = [
    ...
    # OBSIDIAN
    Key([mod], 'o', lazy.spawn(f'xonsh {home}/.scripts/obsidian.xsh'), desc='Open obsidian vault'),
    #CMUS
    #TODO add seek etc
    KeyChord([mod], 'c',
        [
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Sep(),                           
                widget.Cmus(dpi=96, width=200),                                                                           # CMUS
                widget.Sep(),                           
                widget.NvidiaSensors(),
                widget.ThermalSensor(),
                widget.Sep(),                           
                widget.DF(format='{p}_{uf}{m}', visible_on_warn=False),
