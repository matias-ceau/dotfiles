...
keys = [
    ...
    Key(M + C + A, "o", L.to_layout_index(0), desc="Layout 1"),
    Key(M + C + A, "p", L.to_layout_index(1), desc="Layout 2"),
    Key(M + C + A, "bracketleft", L.to_layout_index(2), desc="Layout 3"),
    Key(M + C + A, "k", L.to_layout_index(3), desc="Layout 4"),
    Key(M + C + A, "l", L.to_layout_index(4), desc="Layout 5"),
    Key(M + C + A, "semicolon", L.to_layout_index(5), desc="Layout 6"),
    ...
    Key(
        M + C,
        volumedown,
        L.spawn("xdotool mousemove_relative  -- -10 0"),
        desc="Mouse left",
    ),
    Key(
        M + C,
    ...
    Key(
        M + S + C,
        volumedown,
        L.spawn("xdotool mousemove_relative  -- 0 -10"),
        desc="Mouse down",
    ),
    Key(
        M + S + C,
    ...
    Key(
        M,
        mute,
        L.spawn("xdotool click --clearmodifiers 1"),
        desc="Left click",
    ),
    Key(
        M + S,
