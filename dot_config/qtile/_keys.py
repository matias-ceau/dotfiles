...
keys = [
    ...
    Key(["mod4", "mod1"], "j", lazy.screen.next_group(), desc="Cycle groups"),
    Key(["mod4"], "Left", lazy.screen.prev_group(), desc="Cycle groups"),
    Key(["mod4, mod1"], "k", lazy.screen.prev_group(), desc="Cycle groups"),
    Key(["mod4"], "grave", lazy.next_layout(), desc="Toggle between layouts"),
    # Key(["mod4, mod1"], "o", lazy.spawn(""), desc="Navigate groups history (out)"),
    # Key(["mod4, mod1"], "i", lazy.spawn(""), desc="Navigate group history (in)"),
