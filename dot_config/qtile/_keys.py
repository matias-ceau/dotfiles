...
keys = [
    ...
    Key(["mod4"], "bracketleft", lazy.screen.prev_group(), desc="Cycle groups"),
    ...
    Key( [], "XF86AudioLowerVolume", lazy.widget["volume"].decrease_vol(), desc="Lower volume",),
    Key( [], "XF86AudioRaiseVolume", lazy.widget["volume"].increase_vol(), desc="Raise volume",),
    Key( ["mod4"], "XF86AudioLowerVolume", lazy.spawn("xdotool mousemove_relative -- -50 0"), desc="Mouse right",),
    Key( ["mod4"], "XF86AudioRaiseVolume", lazy.spawn("xdotool mousemove_relative 50 0"), desc="Mouse left",),
    Key( ["mod4", "shift"], "XF86AudioLowerVolume", lazy.spawn("xdotool mousemove_relative -- 0 -50"), desc="Mouse down",),
    Key( ["mod4", "shift"], "XF86AudioRaiseVolume", lazy.spawn("xdotool mousemove_relative 0 50"), desc="Mouse up",),
    Key( ["mod4"], "XF86AudioMute", lazy.spawn("xdotool click 1"), desc="Left click",),
    Key( ["mod4", "shift"], "XF86AudioMute", lazy.spawn("xdotool click 3"), desc="Right click",),
    Key(
        ["mod4"],
        "a",
