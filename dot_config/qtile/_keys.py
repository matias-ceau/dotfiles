...
keys = [
    ...
    Key( ["mod4"], "XF86AudioLowerVolume", lazy.spawn("xdotool mousemove_relative -- -100 0"), desc="Mouse right",),
    Key( ["mod4"], "XF86AudioRaiseVolume", lazy.spawn("xdotool mousemove_relative 100 0"), desc="Mouse left",),
    Key( ["mod4", "shift"], "XF86AudioLowerVolume", lazy.spawn("xdotool mousemove_relative -- 0 -100"), desc="Mouse down",),
    Key( ["mod4", "shift"], "XF86AudioRaiseVolume", lazy.spawn("xdotool mousemove_relative 0 100"), desc="Mouse up",),
