...
config.bind("yg", "spawn --userscript yank-git-repo")
config.bind("yP", "yank pretty-url -s")
config.bind("yt", "yank title")
config.bind("yT", "yank title -s")
config.bind("yy", "yank")
config.bind("yY", "yank -s")
config.bind("yG", "spawn --userscript yank-git-repo -s")
...
config.bind(
    "<Ctrl-Shift-J>", "completion-item-focus next-category", mode="command"
)  # added
# config.bind("<Ctrl-Shift-Tab>", "completion-item-focus prev-category", mode="command")
config.bind(
    "<Ctrl-Shift-K>", "completion-item-focus prev-category", mode="command"
)  # added
