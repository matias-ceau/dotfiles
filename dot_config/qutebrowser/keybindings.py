...
config.bind("<Ctrl-Tab>", "navigate next")
...
config.bind("<Ctrl-N>", "completion-item-focus next-category", mode="command")  # added
config.bind("<Ctrl-P>", "completion-item-focus prev-category", mode="command")  # added
config.bind("<Ctrl-I>", "command-history-next", mode="command")
...
config.bind("<Ctrl-X>", "rl-kill-line", mode="command")
